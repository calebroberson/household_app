...
- Household: Caleb (`3bf30ca6-ba9b-4a96-b8a7-b8232af3cdc5`) + Matthew (joins later, resolved dynamically in scripts as "the other household_members row"). 99 real household chores across 8 areas (Kitchen, Half Bath, Living Room, Stairs, Entryway, Caleb's Room [private], Caleb's Bathroom [private], Home) seeded — see git history for the seed script if it needs re-running or adapting.
